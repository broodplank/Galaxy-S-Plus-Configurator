...
echo.
echo Pushing ICS Light Chrome Keyboard
...
cls
adb -d shell stop
echo Installing ICS Light Chrome Keyboard, please wait...
echo.
adb push "keyboard/light_chrome_ics/AxT9IME.apk" "system/app/AxT9IME.apk"
echo.
